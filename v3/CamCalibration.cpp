...
int CamCalibration::mType()
{
	return 1;
}

int CamCalibration::monocularCalbration(std::string img_path_file_name, cv::Mat& cameraMatrix, cv::Mat& distCoeffs,
	cv::Size board_size, cv::Size square_size)
{
	std::cout << "=============相机标定================\n";
